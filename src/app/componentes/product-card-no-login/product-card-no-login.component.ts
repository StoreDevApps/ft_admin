...
export class ProductCardNoLoginComponent {
  @Input() product: { id: number, name: string, image: string } = { id: 0, name: 'Lapiz 2B', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS11G0DkaNJ6HAPJ4sTAaHXJjJAcUVbCaHFew&s' };
